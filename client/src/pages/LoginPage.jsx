    ...
    <div style={{ background: 'var(--dark)', minHeight: '100vh' }}
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="font-serif text-3xl font-semibold text-white mb-1">Добро пожаловать</h1>
          <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Войдите в свой аккаунт</p>
        </div>
